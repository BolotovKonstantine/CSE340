...
async function passUpdate(req, res) {
    let nav = await utilities.getNav();
...
module.exports = { buildLogin, buildRegister, registerAccount, accountLogin, buildManagement, buildUpdate, accountUpdate, passUpdate, accountLogout }